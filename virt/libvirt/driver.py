...
#vuth
            ...
            channel.alias_name = "virserial-channel1"

#            channel.target_name = "com.redhat.spice.0"
            guest.add_device(channel)

        if CONF.spice.enabled:
#            spice_channel = vconfig.LibvirtConfigGuestSpiceChannel()
#            spice_channel.type = "spicevmc"
#            spice_channel.target_type = "virtio"
#            spice_channel.target_name = "com.redhat.spice.0"
#            spice_channel.alias_name = "virserial-channel1"

#            guest.add_device(spice_channel)
#            video = vconfig.LibvirtConfigGuestVideo()
#            video.type = "qxl"
#            video.vram = "65536"
#            video.heads = "1"
#            guest.add_device(video)
            ...
            sound.address_slot = "0x04"
            sound.address_function = "0x0"
